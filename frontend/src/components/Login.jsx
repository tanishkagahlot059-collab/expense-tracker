...
const Login = ({ onLogin, API_URL = "https://expense-tracker-backend-fsqm.onrender.com" }) => {
    ...
    const persistAuth = (profile, token) => {
        ...
        try {
            ...
            console.error("Stroage Error:", err);
        }
    };
                ...
                <div className={loginStyles.formContainer}>
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className={loginStyles.checkboxContainer}>
                            <input
                                ...
                                required
                            />
                            <label htmlFor='remember' className={loginStyles.checkboxLabel}>Remember Me</label>
                        </div>
                        <button type='submit'
                            disabled={isLoading}
                    ...
                    <div className={loginStyles.signUpContainer}>
                        <p className={loginStyles.signUpText}>
                            ...
                            <Link to="/create-account" className={loginStyles.signUpLink}>
                            Create One </Link>
                        </p>
                    </div>
                </div>
