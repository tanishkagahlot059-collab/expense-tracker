...
import { ArrowDown, ArrowUp, HelpCircle, Home, LogOut, User, X, Menu } from 'lucide-react';
...
const Sidebar = ({ user, isCollapsed, setIsCollapsed }) => {
  ...
  const { name: username = "User", email = "tanugahlot23@gmail.com" } = user || {};
      ...
      >
        <div className={sidebarStyles.sidebarInner.base}>
            ...
            <div className=" flex items-center">
              ...
              {!isCollapsed && (
                ...
                >
                  ...
                  <p className=" text-xs text-gray-500 turncate">{email}</p>
                </motion.div>
              )}
            </div>
          </div>
          ...
          >
            ...
            )} to="https://www.linkedin.com/in/tanishka-gahlot-968443306?utm_source=share_via&utm_content=profile&utm_medium=member_ios"
            >
